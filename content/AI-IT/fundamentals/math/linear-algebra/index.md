...
| 名称 | 说明 | 链接 |
|------|------|------|
| 向量 | 理解向量的概念、运算与应用 | [进入](01-vectors.md) |
| 矩阵 | 理解矩阵的概念、运算与应用 | [进入](02-matrices.md) |
| 特征值分解 | 理解特征值、特征向量与矩阵分解 | [进入](03-eigenvalue-decomposition.md) |
| 奇异值分解 | 理解SVD的原理、计算与应用 | [进入](04-svd.md) |
